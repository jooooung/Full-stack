...
<body>
	...
	<%
		...
		MemberDto dto = dao.getMember("A");
		out.println("A 아이디의 member : " + dto + "<br>");
		dto = dao.getMember("s");
		out.println("s 아이디의 member : " + dto + "<br>");
		
		out.println("<h3>5. 정보수정</h3>");
		dto = new MemberDto("B", "111", "홍길동", null, null, null, null, "q@qqq.com",
				null, "인천", null);
